...
import {SysCourseListDialogComponent} from "./sys-noticeManage.dialog";

@Component({
    selector: 'app-system-courseList',
    templateUrl: 'system-noticeManage.component.html',
    styleUrls: ['system-noticeManage.component.less']
})

export class SystemNoticeManageComponent implements OnInit {
    courseListData: any[] = []
    ...
    constructor(private router: Router,
                ...
                private courseListService: SysNoticeManageService) {
    }
