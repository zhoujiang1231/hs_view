...
@Component({
    selector: 'app-sys-basicFileList',
    template: `
...
export class SysBasicFileListDialogComponent implements OnInit {
    ...
    constructor(private fb: FormBuilder,
                ...
                public dialogRef: MatDialogRef<SysBasicFileListDialogComponent>,
    ...
    reloadFileList(){
        this.sysCustomerManageService.reloadFileList({accountId:LocalStorage.get('accountId')})
            .subscribe(page =>{
